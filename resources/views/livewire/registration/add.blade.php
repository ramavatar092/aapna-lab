<div wire:ignore.self class="modal fade" id="addRegistrationModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle">New {{ trans('cruds.patient_registration.title_singular') }}</h5>
                <button
                    type="button"
                    class="btn-close"
            ...
            <div class="modal-body">
                <form wire:submit.prevent="store">
                    <div class="row g-4">
                        <!-- Designation -->
                        <div class="col-md-4">
                            <label for="designation" class="form-label">{{ trans('cruds.patient_registration.fields.designation') }}<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" wire:model="age" min="2" max="100" class="form-control" id="age" placeholder="{{ trans('cruds.patient_registration.fields.age') }}" >
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="tel"  wire:model="mobile" maxlength="10" class="form-control" id="mobile" placeholder="{{ trans('cruds.patient_registration.fields.mobile') }}">
                            </div>
