    <div wire:ignore.self class="modal fade" id="addPackageModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">New {{ trans('cruds.package.title_singular') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label for="packageName" class="form-label">{{ trans('cruds.package.title_singular') }} Name:</label>
                            <input type="text" id="packageName" wire:model.live="title" class="form-control" placeholder="Enter package name">
                            @error('title') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-md-6">
                            <label for="packageCode" class="form-label">{{ trans('cruds.package.title_singular') }} {{ trans('cruds.package.fields.code') }}:</label>
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item['title'] }}</td>
                                    <td>
                                        <input type="number" wire:model="selectedItems.{{ $index }}.amount" class="form-control border">
                                    </td>
                                    <td>
                    ...
                    <!-- Total Amount Field -->
                    <div class="mb-4">
                        <label for="totalAmount" class="form-label">{{ trans('cruds.package.title_singular') }} {{ trans('cruds.package.fields.amount') }}:</label>
