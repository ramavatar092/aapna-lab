<div>
    <!-- Fullscreen Modal -->
    <div wire:ignore.self class="modal fade" id="updatebillingModal" tabindex="-1" aria-labelledby="billingModalLabel" aria-hidden="true">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <p>Age: <span>{{ $age }} {{ ucwords($age_type) }}</span></p>
                                        <p>Contact Number :<br>{{ $mobile }}</p>
                                        <p>Billing Date :<br>
                                        ...
                                        <p>Organisation : {{ $organisation ? $organisation : 'self' }}</p>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="d-flex justify-content-end gap-2 mt-3">
                                            <button wire:click="updateBill" class="btn btn-outline-primary">Update bill</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            $wire.on('reset-update-bill', () => {
                $('#updatebillingModal').modal('hide');
            });
        });
    </script>
    @endscript
